...
public class DataLoader {
    ...
    private void crearProductos() {
        ...
        Object[][] prods = {
            // ─── Electrónica ───────────────────────────────────────────────
            {"P001","C001","iPhone 15 Pro",         "Smartphone Apple con chip A17 Pro, cámara 48MP y pantalla OLED",              1850000.0, 85,  "Apple"},
            {"P002","C001","Samsung Galaxy S24",    "Smartphone Android con IA integrada, batería 4000mAh y pantalla Dynamic AMOLED",1450000.0,120,  "Samsung"},
            {"P003","C001","MacBook Air M3",        "Laptop ultradelgada con chip M3, 8GB RAM, 256GB SSD y batería de 18 horas",   2800000.0, 45,  "Apple"},
            {"P004","C001","iPad Pro 12.9",         "Tablet profesional con chip M2, pantalla Liquid Retina XDR y Apple Pencil 2", 1750000.0, 60,  "Apple"},
            {"P005","C001","Sony WH-1000XM5",       "Auriculares inalámbricos con cancelación de ruido líder en la industria",      580000.0,200,  "Sony"},
            {"P006","C001","Nintendo Switch OLED",  "Consola híbrida con pantalla OLED de 7 pulgadas y mandos Joy-Con",             520000.0,150,  "Nintendo"},
            // ─── Ropa y Moda ────────────────────────────────────────────────
            {"P007","C002","Zapatillas Air Max 270","Zapatillas deportivas con tecnología Air Max para máxima comodidad",           285000.0,300,  "Nike"},
            {"P008","C002","Remera Básica Pack x3", "Pack de 3 remeras básicas de algodón 100%, disponible en tallas S-XXL",        68000.0,500,  "Zara"},
            {"P009","C002","Jeans 501 Slim",        "Jeans clásico Levi's en corte slim, denim premium de alta durabilidad",       145000.0,250,  "Levi's"},
            {"P010","C002","Campera Thermoball",    "Campera de plumas sintéticas Thermoball para climas fríos y montaña",         480000.0,100,  "The North Face"},
            {"P011","C002","Vestido Floral",        "Vestido casual con estampado floral, ideal para primavera y verano",           95000.0,180,  "H&M"},
            {"P012","C002","Mochila 25L Urban",     "Mochila urbana de 25 litros con compartimento para laptop y diseño ergonómico",195000.0,120,  "Samsonite"},
            // ─── Hogar y Jardín ─────────────────────────────────────────────
            {"P013","C003","Sillón Reclinable Oslo","Sillón reclinable de cuero sintético con reposapiés y posición TV",           680000.0, 40,  "IKEA"},
            {"P014","C003","Sábanas Premium 500H",  "Set de sábanas de microfibra 500 hilos, suaves y resistentes al lavado",      120000.0,300,  "Casa & Estilo"},
            {"P015","C003","Cafetera Espresso",     "Cafetera de cápsula Nespresso compatible con 19 bares de presión",            520000.0, 75,  "De'Longhi"},
            {"P016","C003","Aspiradora Robot i7+",  "Robot aspiradora con vaciado automático y navegación con IA por cámara",      980000.0, 30,  "iRobot"},
            {"P017","C003","Lámpara de Pie Hue",    "Lámpara de pie inteligente Philips Hue con 16 millones de colores y voz",     380000.0, 90,  "Philips"},
            {"P018","C003","Mesa de Centro Lack",   "Mesa de centro minimalista de madera lacada, 90x55cm, varios colores",        135000.0,150,  "IKEA"},
            // ─── Deportes ────────────────────────────────────────────────────
            {"P019","C004","Bicicleta Marlin 5",    "Bicicleta de montaña con cuadro de aluminio, 21 velocidades y frenos de disco",1580000.0, 25,  "Trek"},
            {"P020","C004","Pesas Ajustables 32kg", "Set de pesas ajustables de 2 a 32kg en 15 configuraciones, antideslizantes",  450000.0, 60,  "PowerBlock"},
            {"P021","C004","Raqueta Blade 98",      "Raqueta de tenis profesional con tecnología Countervail para menos vibración", 320000.0, 80,  "Wilson"},
            {"P022","C004","Colchoneta de Yoga 5mm","Colchoneta antideslizante de 5mm, con correa de transporte y diseño Premium",   98000.0,200,  "Lululemon"},
            {"P023","C004","Pelota Fútbol CL",      "Pelota oficial Champions League UEFA con tecnología Thermobonding",            115000.0,400,  "Adidas"},
            {"P024","C004","Cinta de Correr T100",  "Cinta de correr plegable con velocidad hasta 16km/h y pantalla LCD",          890000.0, 20,  "Domyos"},
            // ─── Libros y Cultura ────────────────────────────────────────────
            {"P025","C005","El Señor de los Anillos","Trilogía completa de J.R.R. Tolkien, edición especial con ilustraciones",      22500.0,200,  "Minotauro"},
            {"P026","C005","Clean Code",            "Guía de principios SOLID y buenas prácticas de programación de Robert C. Martin",28000.0,150,  "Prentice Hall"},
            {"P027","C005","Cien Años de Soledad",  "Obra maestra de Gabriel García Márquez, Premio Nobel de Literatura",            16500.0,300,  "Sudamericana"},
            {"P028","C005","El Problema de 3 Cuerpos","Trilogía de ciencia ficción de Liu Cixin, bestseller internacional",          20000.0,180,  "Nova"},
            {"P029","C005","Atomic Habits",         "Guía de James Clear para construir hábitos con pequeños cambios consistentes",  18500.0,250,  "Paidós"},
            {"P030","C005","System Design Interview","Guía de Alex Xu para entrevistas de diseño de sistemas de software",           32000.0,100,  "ByteByteGo"},
        };
        try (Session s = config.getSession()) {
            for (Object[] p : prods) {
                s.run(q, Map.of(
    ...
    private void crearPedidos() {
        ...
        Object[][][] pedidos = {
            ...
            {{"O001","U001","2026-03-15","COMPLETADO", 2430000.0,"Tarjeta de crédito","Av. Corrientes 1500, CABA"},
             {"P001","1","1850000"},{"P005","1","580000"}},
            {{"O002","U001","2026-07-20","COMPLETADO", 2800000.0,"MercadoPago","Av. Corrientes 1500, CABA"},
             {"P003","1","2800000"}},
            // U002 María
            {{"O003","U002","2026-02-10","COMPLETADO", 3600000.0,"Tarjeta de crédito","B° Alberdi 340, Córdoba"},
             {"P001","1","1850000"},{"P004","1","1750000"}},
            {{"O004","U002","2026-08-05","ENVIADO",    2030000.0,"Débito","B° Alberdi 340, Córdoba"},
             {"P002","1","1450000"},{"P005","1","580000"}},
            // U003 Juan
            {{"O005","U003","2026-01-22","COMPLETADO", 3380000.0,"Tarjeta de crédito","San Martín 820, Rosario"},
             {"P003","1","2800000"},{"P005","1","580000"}},
            {{"O006","U003","2026-06-18","COMPLETADO",  520000.0,"MercadoPago","San Martín 820, Rosario"},
             {"P006","1","520000"}},
            // U004 Ana - ropa
            {{"O007","U004","2026-04-12","COMPLETADO",  430000.0,"Débito","Las Heras 215, Mendoza"},
             {"P007","1","285000"},{"P009","1","145000"}},
            {{"O008","U004","2026-09-01","COMPLETADO",  675000.0,"Tarjeta de crédito","Las Heras 215, Mendoza"},
             {"P010","1","480000"},{"P012","1","195000"}},
            // U005 Pedro - deportes
            {{"O009","U005","2026-03-28","COMPLETADO", 1865000.0,"MercadoPago","Italia 560, La Plata"},
             {"P007","1","285000"},{"P019","1","1580000"}},
            {{"O010","U005","2026-10-05","PENDIENTE",   328000.0,"Débito","Italia 560, La Plata"},
             {"P023","2","115000"},{"P022","1","98000"}},
            // U006 Lucía - ropa
            {{"O011","U006","2026-05-20","COMPLETADO",  394000.0,"Tarjeta de crédito","Palermo 320, CABA"},
             {"P008","3","68000"},{"P011","2","95000"}},
            {{"O012","U006","2026-11-10","COMPLETADO",  625000.0,"MercadoPago","Palermo 320, CABA"},
             {"P009","1","145000"},{"P010","1","480000"}},
            // U007 Diego - hogar
            {{"O013","U007","2026-02-28","COMPLETADO",  815000.0,"Tarjeta de crédito","San Juan 750, Tucumán"},
             {"P013","1","680000"},{"P018","1","135000"}},
            {{"O014","U007","2026-07-15","COMPLETADO",  980000.0,"MercadoPago","San Juan 750, Tucumán"},
             {"P016","1","980000"}},
            // U008 Valentina - hogar
            {{"O015","U008","2026-04-05","COMPLETADO",  760000.0,"Débito","Urquiza 180, Salta"},
             {"P014","2","120000"},{"P015","1","520000"}},
            {{"O016","U008","2026-08-22","ENVIADO",     380000.0,"Tarjeta de crédito","Urquiza 180, Salta"},
             {"P017","1","380000"}},
            // U009 Martín - hogar
            {{"O017","U009","2026-03-10","COMPLETADO", 1200000.0,"Tarjeta de crédito","Güemes 900, Mar del Plata"},
             {"P015","1","520000"},{"P013","1","680000"}},
            {{"O018","U009","2026-09-14","COMPLETADO",  510000.0,"MercadoPago","Güemes 900, Mar del Plata"},
             {"P014","2","120000"},{"P018","2","135000"}},
            // U010 Florencia - libros
            {{"O019","U010","2026-01-15","COMPLETADO",   67000.0,"Tarjeta de crédito","Recoleta 440, CABA"},
             {"P025","1","22500"},{"P026","1","28000"},{"P027","1","16500"}},
            {{"O020","U010","2026-06-30","COMPLETADO",   38500.0,"MercadoPago","Recoleta 440, CABA"},
             {"P028","1","20000"},{"P029","1","18500"}},
            // U011 Rodrigo - libros
            {{"O021","U011","2026-02-20","COMPLETADO",   60000.0,"Débito","Nueva Córdoba 220, Córdoba"},
             {"P026","1","28000"},{"P030","1","32000"}},
            {{"O022","U011","2026-08-08","COMPLETADO",   36500.0,"MercadoPago","Nueva Córdoba 220, Córdoba"},
             {"P027","1","16500"},{"P028","1","20000"}},
            // U012 Camila - libros
            {{"O023","U012","2026-03-05","COMPLETADO",   41000.0,"Tarjeta de crédito","Pichincha 380, Rosario"},
             {"P025","1","22500"},{"P029","1","18500"}},
            {{"O024","U012","2026-10-20","PENDIENTE",    32000.0,"MercadoPago","Pichincha 380, Rosario"},
             {"P030","1","32000"}},
            // U013 Santiago - mixed (tech + deportes)
            {{"O025","U013","2026-04-18","COMPLETADO", 2135000.0,"Tarjeta de crédito","Puerto Madero 10, CABA"},
             {"P001","1","1850000"},{"P007","1","285000"}},
            {{"O026","U013","2026-09-25","COMPLETADO", 1608000.0,"MercadoPago","Puerto Madero 10, CABA"},
             {"P019","1","1580000"},{"P026","1","28000"}},
            // U014 Natalia
            {{"O027","U014","2026-05-10","COMPLETADO",  618000.0,"Débito","Chacras 85, Mendoza"},
             {"P015","1","520000"},{"P022","1","98000"}},
            // U015 Tomás - deportes
            {{"O028","U015","2026-06-22","COMPLETADO",  770000.0,"Tarjeta de crédito","Bv. Gálvez 612, Santa Fe"},
             {"P020","1","450000"},{"P021","1","320000"}},
            // U016 Agustina - ropa
            {{"O029","U016","2026-07-08","COMPLETADO",  530000.0,"MercadoPago","Rivadavia 300, La Plata"},
             {"P008","5","68000"},{"P011","2","95000"}},
            // U017 Facundo
            {{"O030","U017","2026-08-14","COMPLETADO",  520000.0,"Débito","Villa Urquiza 780, CABA"},
             {"P006","1","520000"}},
            // U018 Micaela (cancelado)
            {{"O031","U018","2026-09-02","CANCELADO",  1450000.0,"Tarjeta de crédito","Bernal 200, Córdoba"},
             {"P002","1","1450000"}},
            // U019 Ignacio - deportes
            {{"O032","U019","2026-10-12","COMPLETADO", 1340000.0,"MercadoPago","Yerba Buena 540, Tucumán"},
             {"P024","1","890000"},{"P020","1","450000"}},
            // U020 Celeste - tech
            {{"O033","U020","2026-11-05","ENVIADO",    1750000.0,"Tarjeta de crédito","Caballito 90, CABA"},
             {"P004","1","1750000"}},
            // U001 Carlos - también compró un libro
            {{"O034","U001","2026-12-01","COMPLETADO",   28000.0,"MercadoPago","Av. Corrientes 1500, CABA"},
             {"P026","1","28000"}},
            // U005 Pedro - también compró pesas
            {{"O035","U005","2026-11-20","COMPLETADO",  450000.0,"Débito","Italia 560, La Plata"},
             {"P020","1","450000"}},
        };
